...
func New(
	...
	app.NotesKeeper = *notesmodulekeeper.NewKeeper(
		appCodec,
		keys[notesmoduletypes.StoreKey],
		keys[notesmoduletypes.MemStoreKey],
		app.GetSubspace(notesmoduletypes.ModuleName),
	)
	notesModule := notesmodule.NewAppModule(appCodec, app.NotesKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(notesmoduletypes.ModuleName)
